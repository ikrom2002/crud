from post.views import article_func, article_detail, article_create,article_edit,article_delete,like_article,dislike_article,delete_comment,edit_comment
